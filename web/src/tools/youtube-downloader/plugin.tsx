    ...
    <>
      ...
      <section className="tool-workspace download-workspace">
        ...
        <JobProgressPanel
          ...
          waitingMeta="Submit a permitted video URL to begin."
          title={(current) => current.title || "Preparing media…"}
          meta={(current) => `${current.format.toUpperCase()} · ${formatDuration(current.durationSeconds)}`}
